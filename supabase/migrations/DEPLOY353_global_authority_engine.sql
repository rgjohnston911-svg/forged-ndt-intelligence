...
INSERT INTO global_edition_registry (code, current_edition, current_year, previous_editions, issuing_body, official_source_url, last_verified, verification_source, withdrawn, superseded_by) VALUES
  ('API 570', '4th Edition, February 2016 (Addendum 1, April 2021)', 2016, ARRAY['3rd Edition, 2009', '2nd Edition, 1998'], 'American Petroleum Institute', 'https://www.api.org/products-and-services/standards', '2026-04-01', 'API Publications Store', false, NULL),
  ('API 510', '11th Edition, May 2023', 2023, ARRAY['10th Edition, 2014', '9th Edition, 2006'], 'American Petroleum Institute', 'https://www.api.org/products-and-services/standards', '2026-04-01', 'API Publications Store', false, NULL),
  ('API 579-1/ASME FFS-1', '3rd Edition, June 2021', 2021, ARRAY['2nd Edition, 2016', '1st Edition, 2007'], 'API / ASME', 'https://www.api.org/products-and-services/standards', '2026-04-01', 'API Publications Store', false, NULL),
  ('API 1104', '22nd Edition, 2019 (Errata 1, 2020)', 2019, ARRAY['21st Edition, 2013', '20th Edition, 2005'], 'American Petroleum Institute', 'https://www.api.org/products-and-services/standards', '2026-04-01', 'API Publications Store', false, NULL),
  ('ASME BPVC Section VIII', '2023 Edition', 2023, ARRAY['2021 Edition', '2019 Edition'], 'ASME', 'https://www.asme.org/codes-standards/find-codes-standards/bpvc', '2026-04-01', 'ASME Standards Store', false, NULL),
  ('ASME B31.3', '2022 Edition', 2022, ARRAY['2020 Edition', '2018 Edition'], 'ASME', 'https://www.asme.org/codes-standards', '2026-04-01', 'ASME Standards Store', false, NULL),
  ('AWS D1.1', 'AWS D1.1/D1.1M:2020', 2020, ARRAY['D1.1:2015', 'D1.1:2010'], 'American Welding Society', 'https://pubs.aws.org', '2026-04-01', 'AWS Pubs Store', false, NULL),
  ('AWS D1.5', 'AWS D1.5M/D1.5:2020', 2020, ARRAY['D1.5:2015', 'D1.5:2010'], 'American Welding Society', 'https://pubs.aws.org', '2026-04-01', 'AWS Pubs Store', false, NULL),
  ('EN 13445', 'EN 13445:2021 (Parts 1-10)', 2021, ARRAY['EN 13445:2014', 'EN 13445:2009'], 'CEN', 'https://www.en-standard.eu', '2026-04-01', 'CEN/CENELEC', false, NULL),
  ('PED 2014/68/EU', 'Directive 2014/68/EU (effective 2016)', 2014, ARRAY['Directive 97/23/EC (repealed 2016)'], 'European Parliament / Council', 'https://eur-lex.europa.eu', '2026-04-01', 'EUR-Lex', false, NULL),
  ('BS 7910', 'BS 7910:2019+A1:2024', 2019, ARRAY['BS 7910:2013+A1:2015', 'BS 7910:2005'], 'BSI', 'https://shop.bsigroup.com', '2026-04-01', 'BSI Shop', false, NULL),
  ('CSA Z662', 'CSA Z662:2023', 2023, ARRAY['CSA Z662:2019', 'CSA Z662:2015'], 'CSA Group', 'https://www.csagroup.org', '2026-04-01', 'CSA Store', false, NULL),
  ('NORSOK M-001', 'NORSOK M-001:2014 (Ed. 5)', 2014, ARRAY['Rev. 4, 2004', 'Rev. 3, 2002'], 'Standard Norge', 'https://www.standard.no', '2026-04-01', 'Standard Norge', false, NULL),
  ('DNV-ST-F101', 'DNV-ST-F101 (2021)', 2021, ARRAY['DNV-OS-F101 (2013)', 'DNV-OS-F101 (2010)'], 'DNV', 'https://www.dnv.com/rules-standards', '2026-04-01', 'DNV Rules Store', false, NULL),
  ('PED 97/23/EC', 'WITHDRAWN — replaced by PED 2014/68/EU', 1997, ARRAY[]::TEXT[], 'European Parliament', 'https://eur-lex.europa.eu', '2026-04-01', 'EUR-Lex', true, 'PED 2014/68/EU'),
  ('API RP 579', 'SUPERSEDED — replaced by API 579-1/ASME FFS-1', 2000, ARRAY[]::TEXT[], 'API', 'https://www.api.org', '2026-04-01', 'API Publications Store', false, 'API 579-1/ASME FFS-1'),
  ('BS PD 6493', 'WITHDRAWN — replaced by BS 7910', 1991, ARRAY[]::TEXT[], 'BSI', 'https://shop.bsigroup.com', '2026-04-01', 'BSI Shop', true, 'BS 7910'),
  ('DNV-OS-F101', 'SUPERSEDED — replaced by DNV-ST-F101 (2021)', 2013, ARRAY['2010', '2007'], 'DNV', 'https://www.dnv.com', '2026-04-01', 'DNV Rules Store', false, 'DNV-ST-F101')
