// ============================================================================
// FORGED NDT INTELLIGENCE OS -- SYSTEM TEST v2.1
...
(function() {
  ...
  // v2.9.x returns domain_not_supported=true (not domain_refusal.refused)
  function T1() {
    return post("decision-core", {
      ...
      record("T1: Domain Refusal (nuclear)", refused && ver.indexOf("v2.9") >= 0, "refused=" + refused + " ver=" + ver);
  ...
  function T8() {
    return post("decision-core", {
      ...
      var passed = ver.indexOf("v2.9") >= 0 && primary !== "?" && tier !== "?" && disp !== "?";
