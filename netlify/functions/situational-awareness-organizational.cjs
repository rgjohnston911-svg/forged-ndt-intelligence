...
var ORG_PATTERNS = [
  ...
  { id: 'MISSED_INSPECTION', category: 'INSPECTION_PROGRAM_FAILURE', severity: 'HIGH',
    keywords: ['overdue', 'past due', 'missed inspection', 'inspection overdue', 'survey overdue',
               'behind schedule', 'not inspected', 'lapsed', 'expired inspection', 'overdue for',
               'assessment overdue', 'test overdue', 'recertification', 'overdue inspection',
               'overdue for testing', 'overdue for test'] },
  ...
  { id: 'SCHEDULE_PRESSURE_OVERRIDE', category: 'PRODUCTION_PRESSURE', severity: 'MEDIUM',
    keywords: ['cannot shut down', 'cannot happen before', 'cannot shutdown', 'shutdown cannot',
               ...
               'export obligations', 'export commitments', 'record exports', 'continue production',
               'continue operating', 'continue service', 'continued service', 'continued operation'] },
  ...
  { id: 'DEFERRED_MAINTENANCE', category: 'MAINTENANCE_DEFERRAL', severity: 'HIGH',
    keywords: ['deferred maintenance', 'maintenance backlog', 'maintenance deferred', 'backlog',
               ...
               'turnaround delayed', 'turnaround postponed', 'turnaround deferred', 'postponed',
               'deferred pigging', 'pigging campaign', 'procurement delays', 'spillway unavailable',
               'intervention delayed', 'deferred intervention'] },
  ...
  { id: 'PERSONNEL_TURNOVER', category: 'COMPETENCY_RISK', severity: 'MEDIUM',
    keywords: ['turnover in experienced', 'recent turnover', 'personnel turnover', 'staff turnover',
               ...
               'key personnel departed', 'personnel recently departed', 'personnel departed', 'departed organization',
               'contractor turnover', 'control room turnover'] },
  { id: 'INCENTIVE_BIAS', category: 'DECISION_CONTAMINATION', severity: 'MEDIUM',
    keywords: ['incentives tied to production', 'incentives tied to', 'management incentives',
               'bonus tied to', 'compensation tied to', 'incentivized to', 'production incentives active',
               'production incentives', 'geopolitical', 'national export', 'economic pressure'] },
  // DEPLOY392 - categories surfaced by the diverse real-world scenario set.
  { id: 'DESIGN_BASIS_LOSS', category: 'KNOWLEDGE_LOSS', severity: 'HIGH',
    keywords: ['design calculations unavailable', 'original design calculations', 'calculations unavailable',
               'original calculations', 'design basis', 'design basis updated', 'design basis drift',
               'material traceability', 'traceability incomplete', 'records missing', 'records unavailable',
               'records incomplete', 'pwht records missing', 'pwht records', 'manufacturer no longer exists',
               'no longer exists', 'oem no longer', 'obsolete', 'older loading criteria', 'older environmental',
               'older design', 'older assumptions', 'design assumptions updated', 'seismic design assumptions'] },
  { id: 'UNDOCUMENTED_REPAIR', category: 'CONFIGURATION_CONTROL', severity: 'HIGH',
    keywords: ['undocumented repair', 'material substitution', 'temporary repair', 'temporary repairs remain',
               'repair by contractor', 'contractor performed', 'weld repair', 'repair exceeds approval',
               'exceeds approval period', 'temporary chemical injection', 'skid installed', 'temporary skid'] },
  ...
  { id: 'COST_DRIVEN_CUTS', category: 'COST_PRESSURE', severity: 'HIGH',
    keywords: ['reduced to save costs', 'to save costs', 'cost cutting', 'cost-cutting', 'budget reduced',
               ...
               'budget cut'] },
  { id: 'SAFETY_BARRIER_DEGRADATION', category: 'BARRIER_FAILURE', severity: 'CRITICAL',
    keywords: ['evacuation system failed', 'evacuation drill failed', 'failed previous drill', 'failed previous test',
               'gas detection system failed', 'gas detection failed', 'firewater test failed', 'firewater flow test marginal',
               'last firewater', 'firewater test marginal', 'emergency closure overdue', 'emergency closure test overdue',
               'emergency system overdue', 'cp system offline', 'cp system intermittently', 'cathodic protection.*offline',
               'protection system', 'lifeboat davits', 'davits overdue', 'aging cathodic protection', 'detection system failed',
               'emergency response contractor', 'emergency spillway unavailable'] }
];
