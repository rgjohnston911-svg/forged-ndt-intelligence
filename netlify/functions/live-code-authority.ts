...
var STANDARDS_DB = [
  ...
  { body: "AWS", designation: "AWS D1.5", title: "Bridge Welding Code", current_edition: "2020 Edition (8th)", current_year: 2020, domains: ["structural_welding", "bridges", "highway", "AASHTO"], materials: ["structural_steel", "HPS_steel", "weathering_steel"], damage_modes: ["weld_defects", "fatigue", "fracture"], thresholds: {} },
  ...
  { body: "AWS", designation: "AWS D1.8", title: "Structural Welding Code - Seismic Supplement", current_edition: "2016 Edition (2nd)", current_year: 2016, domains: ["structural_welding", "seismic", "buildings", "demand_critical"], materials: ["structural_steel"], damage_modes: ["weld_defects", "fatigue", "fracture"], thresholds: {} },
  ...
  // API — Storage Tanks
  { body: "API", designation: "API 650", title: "Welded Tanks for Oil Storage", current_edition: "13th Edition", current_year: 2020, addendum: "Addendum 4 (2023)", previous_edition: "12th Edition", previous_year: 2013, domains: ["storage_tanks", "oil_storage", "terminals", "refining"], materials: ["carbon_steel", "stainless_steel"], damage_modes: ["corrosion", "settlement", "cracking", "weld_defects"], thresholds: { min_shell_thickness_mm: 6.0, min_bottom_thickness_mm: 6.0 } },
