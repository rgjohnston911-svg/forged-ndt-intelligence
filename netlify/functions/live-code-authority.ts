...
var STANDARDS_DB = [
  ...
  { body: "API", designation: "API 510", title: "Pressure Vessel Inspection Code", current_edition: "11th Edition", current_year: 2022, errata: "Errata 2 (2025)", previous_edition: "10th Edition", previous_year: 2014, domains: ["pressure_vessels", "refining", "chemical", "petrochemical"], materials: ["carbon_steel", "low_alloy", "stainless_steel", "high_alloy"], damage_modes: ["corrosion", "cracking", "creep", "erosion"], thresholds: { min_thickness: "Per MAWP calculation", corrosion_allowance: "Per owner/user specification", inspection_interval_max_years: 10 } },
  ...
  { body: "API", designation: "API 653", title: "Tank Inspection, Repair, Alteration, and Reconstruction", current_edition: "5th Edition", current_year: 2014, addendum: "Addendum 4 (2022)", previous_edition: "4th Edition", previous_year: 2009, domains: ["storage_tanks", "refining", "terminals"], materials: ["carbon_steel"], damage_modes: ["corrosion", "settlement", "cracking"], thresholds: { external_interval_max_years: 10, internal_interval_max_years: 20, shell_minimum_thickness_mm: 2.5 } },
  ...
  // ASME — Pressure
  { body: "ASME", designation: "ASME BPVC Section VIII Div 1", title: "Rules for Construction of Pressure Vessels", current_edition: "2025 Edition", current_year: 2025, previous_edition: "2023 Edition", previous_year: 2023, domains: ["pressure_vessels"], materials: ["all"], damage_modes: ["all"], thresholds: {} },
  { body: "ASME", designation: "ASME BPVC Section V", title: "Nondestructive Examination", current_edition: "2025 Edition", current_year: 2025, previous_edition: "2023 Edition", previous_year: 2023, domains: ["NDE", "all"], materials: ["all"], damage_modes: ["all"], thresholds: {} },
  ...
  // AWS — Welding Codes (Complete Family)
  { body: "AWS", designation: "AWS D1.1", title: "Structural Welding Code - Steel", current_edition: "2025 Edition (26th)", current_year: 2025, previous_edition: "2020 Edition (25th)", previous_year: 2020, domains: ["structural_welding", "civil", "buildings", "bridges"], materials: ["structural_steel", "carbon_steel", "HSLA"], damage_modes: ["weld_defects", "fatigue"], thresholds: {} },
  { body: "AWS", designation: "AWS D1.2", title: "Structural Welding Code - Aluminum", current_edition: "2014 Edition (5th)", current_year: 2014, domains: ["structural_welding", "aluminum", "marine", "transportation"], materials: ["aluminum", "5xxx_series", "6xxx_series"], damage_modes: ["weld_defects", "hot_cracking"], thresholds: {} },
  { body: "AWS", designation: "AWS D1.3", title: "Structural Welding Code - Sheet Steel", current_edition: "2018 Edition (2nd)", current_year: 2018, domains: ["structural_welding", "sheet_steel", "light_gauge"], materials: ["sheet_steel", "galvanized_steel"], damage_modes: ["weld_defects", "burn_through"], thresholds: {} },
  { body: "AWS", designation: "AWS D1.4", title: "Structural Welding Code - Reinforcing Steel", current_edition: "2011 Edition (2nd)", current_year: 2011, domains: ["structural_welding", "reinforcing_steel", "concrete", "construction"], materials: ["reinforcing_bar", "carbon_steel"], damage_modes: ["weld_defects"], thresholds: {} },
  { body: "AWS", designation: "AWS D1.5", title: "Bridge Welding Code", current_edition: "2025 Edition (9th)", current_year: 2025, previous_edition: "2020 Edition (8th)", previous_year: 2020, domains: ["structural_welding", "bridges", "highway", "AASHTO"], materials: ["structural_steel", "HPS_steel", "weathering_steel"], damage_modes: ["weld_defects", "fatigue", "fracture"], thresholds: {} },
  { body: "AWS", designation: "AWS D1.6", title: "Structural Welding Code - Stainless Steel", current_edition: "2017 Edition (2nd)", current_year: 2017, domains: ["structural_welding", "stainless_steel", "food_processing", "pharmaceutical"], materials: ["austenitic_stainless", "duplex", "martensitic", "ferritic"], damage_modes: ["weld_defects", "hot_cracking", "sensitization"], thresholds: {} },
  { body: "AWS", designation: "AWS D1.8", title: "Structural Welding Code - Seismic Supplement", current_edition: "2025 Edition (5th)", current_year: 2025, previous_edition: "2016 Edition (2nd)", previous_year: 2016, domains: ["structural_welding", "seismic", "buildings", "demand_critical"], materials: ["structural_steel"], damage_modes: ["weld_defects", "fatigue", "fracture"], thresholds: {} },
  { body: "AWS", designation: "AWS D3.6M", title: "Underwater Welding Code", current_edition: "2017 Edition", current_year: 2017, domains: ["underwater_welding", "subsea", "offshore", "marine"], materials: ["carbon_steel", "structural_steel"], damage_modes: ["weld_defects", "hydrogen_cracking", "porosity"], thresholds: {} },
  { body: "AWS", designation: "AWS D17.1", title: "Specification for Fusion Welding for Aerospace Applications", current_edition: "2024 Edition (4th)", current_year: 2024, previous_edition: "2017 Edition (2nd)", previous_year: 2017, domains: ["aerospace", "aviation", "defense", "space"], materials: ["titanium", "aluminum", "nickel_alloy", "stainless_steel", "cobalt_alloy"], damage_modes: ["weld_defects", "fatigue"], thresholds: {} },

  // API — Welding
  { body: "API", designation: "API 1104", title: "Welding of Pipelines and Related Facilities", current_edition: "22nd Edition", current_year: 2021, previous_edition: "21st Edition", previous_year: 2013, domains: ["pipelines", "welding"], materials: ["carbon_steel", "low_alloy"], damage_modes: ["weld_defects"], thresholds: {} },

  // API — Storage Tanks
  { body: "API", designation: "API 650", title: "Welded Tanks for Oil Storage", current_edition: "14th Edition", current_year: 2025, previous_edition: "13th Edition", previous_year: 2020, domains: ["storage_tanks", "oil_storage", "terminals", "refining"], materials: ["carbon_steel", "stainless_steel"], damage_modes: ["corrosion", "settlement", "cracking", "weld_defects"], thresholds: { min_shell_thickness_mm: 6.0, min_bottom_thickness_mm: 6.0 } },

  // API — HTHA
  { body: "API", designation: "API 941", title: "Steels for Hydrogen Service at Elevated Temperatures and Pressures in Petroleum Refineries and Petrochemical Plants", current_edition: "8th Edition", current_year: 2016, addendum: "Addendum 1 (2020)", domains: ["refining", "hydrogen_service", "HTHA"], materials: ["carbon_steel", "low_alloy", "Cr_Mo"], damage_modes: ["HTHA", "hydrogen_attack"], thresholds: {} },

  // ASME — Nuclear
  { body: "ASME", designation: "ASME BPVC Section III", title: "Rules for Construction of Nuclear Facility Components", current_edition: "2025 Edition", current_year: 2025, previous_edition: "2023 Edition", previous_year: 2023, domains: ["nuclear", "reactor_vessels", "nuclear_piping", "nuclear_components"], materials: ["carbon_steel", "stainless_steel", "nickel_alloy", "low_alloy"], damage_modes: ["fatigue", "corrosion", "irradiation", "SCC"], thresholds: {} },
  { body: "ASME", designation: "ASME BPVC Section XI", title: "Rules for Inservice Inspection of Nuclear Power Plant Components", current_edition: "2025 Edition", current_year: 2025, previous_edition: "2023 Edition", previous_year: 2023, domains: ["nuclear", "inservice_inspection", "nuclear_piping"], materials: ["all"], damage_modes: ["fatigue", "IGSCC", "irradiation_embrittlement", "flow_accelerated_corrosion"], thresholds: {} },

  // ASME — Piping (updated editions)
  { body: "ASME", designation: "ASME B31.1", title: "Power Piping", current_edition: "2024 Edition", current_year: 2024, domains: ["power_piping", "boiler_external", "power_generation"], materials: ["carbon_steel", "alloy_steel", "stainless_steel"], damage_modes: ["creep", "fatigue", "corrosion"], thresholds: {} },
  { body: "ASME", designation: "ASME B31.3", title: "Process Piping", current_edition: "2024 Edition", current_year: 2024, previous_edition: "2022 Edition", previous_year: 2022, domains: ["piping", "chemical", "refining", "petrochemical"], materials: ["all"], damage_modes: ["all"], thresholds: {} },
  { body: "ASME", designation: "ASME B31.4", title: "Pipeline Transportation Systems for Liquids and Slurries", current_edition: "2022 Edition", current_year: 2022, domains: ["pipelines", "liquid_pipelines", "crude_oil", "refined_products"], materials: ["carbon_steel"], damage_modes: ["corrosion", "fatigue", "external_damage"], thresholds: {} },
  { body: "ASME", designation: "ASME B31.8", title: "Gas Transmission and Distribution Piping Systems", current_edition: "2022 Edition", current_year: 2022, domains: ["pipelines", "gas_pipelines", "natural_gas", "distribution"], materials: ["carbon_steel", "PE_pipe"], damage_modes: ["corrosion", "fatigue", "SCC", "third_party_damage"], thresholds: {} },
  { body: "ASME", designation: "ASME B31.12", title: "Hydrogen Piping and Pipelines", current_edition: "2019 Edition", current_year: 2019, domains: ["hydrogen", "pipelines", "piping", "energy_transition"], materials: ["carbon_steel", "stainless_steel", "nickel_alloy"], damage_modes: ["hydrogen_embrittlement", "fatigue", "corrosion"], thresholds: {} },

  // Railroad
  { body: "AREMA", designation: "AREMA Chapter 4", title: "Manual for Railway Engineering - Rail", current_edition: "2023 Edition", current_year: 2023, domains: ["railroad", "rail_welding", "track", "transportation"], materials: ["rail_steel", "head_hardened_rail"], damage_modes: ["fatigue", "wear", "weld_defects", "rolling_contact_fatigue"], thresholds: {} },

  // Architectural / Structural Engineering
  { body: "AISC", designation: "AISC 360", title: "Specification for Structural Steel Buildings", current_edition: "2022 (16th Edition)", current_year: 2022, domains: ["buildings", "structural_steel", "construction", "architecture"], materials: ["structural_steel", "HSS", "W_shapes"], damage_modes: ["fatigue", "buckling", "fracture"], thresholds: {} },
  { body: "ICC", designation: "IBC 2024", title: "International Building Code", current_edition: "2024 Edition", current_year: 2024, domains: ["buildings", "construction", "architecture", "structural"], materials: ["all"], damage_modes: ["all"], thresholds: {} },
  { body: "AASHTO", designation: "AASHTO LRFD Bridge Design", title: "AASHTO LRFD Bridge Design Specifications", current_edition: "9th Edition", current_year: 2020, addendum: "Interim 2024", domains: ["bridges", "highway", "structural", "transportation"], materials: ["structural_steel", "HPS_steel", "concrete", "prestressed"], damage_modes: ["fatigue", "fracture", "corrosion"], thresholds: {} },

  // Coatings Standards
  { body: "SSPC", designation: "SSPC-SP 5/NACE No. 1", title: "White Metal Blast Cleaning", current_edition: "2007 Edition", current_year: 2007, domains: ["coatings", "surface_preparation", "blast_cleaning"], materials: ["carbon_steel"], damage_modes: ["corrosion"], thresholds: { cleanliness: "Sa 3 per ISO 8501-1" } },
  { body: "SSPC", designation: "SSPC-SP 10/NACE No. 2", title: "Near-White Metal Blast Cleaning", current_edition: "2007 Edition", current_year: 2007, domains: ["coatings", "surface_preparation", "blast_cleaning"], materials: ["carbon_steel"], damage_modes: ["corrosion"], thresholds: { cleanliness: "Sa 2.5 per ISO 8501-1" } },
  { body: "SSPC", designation: "SSPC-PA 2", title: "Measurement of Dry Coating Thickness with Magnetic Gages", current_edition: "2020 Edition", current_year: 2020, domains: ["coatings", "inspection", "DFT_measurement"], materials: ["coated_steel"], damage_modes: ["coating_failure"], thresholds: { individual_min_pct: 80, average_requirement: "must_meet_specified" } },
  { body: "AMPP (formerly NACE)", designation: "NACE SP0188 / AMPP SP21478", title: "Discontinuity (Holiday) Testing of New Protective Coatings on Conductive Substrates", current_edition: "2022 Edition", current_year: 2022, domains: ["coatings", "holiday_testing", "inspection"], materials: ["coated_steel", "coated_concrete"], damage_modes: ["coating_failure", "holidays"], thresholds: {} },
  { body: "AMPP (formerly NACE)", designation: "NACE SP0198 / AMPP SP21090", title: "Control of Corrosion Under Thermal Insulation and Fireproofing Materials", current_edition: "2017 Edition", current_year: 2017, domains: ["CUI", "insulation", "fireproofing", "refining", "chemical"], materials: ["carbon_steel", "stainless_steel"], damage_modes: ["CUI", "corrosion", "SCC"], thresholds: {} },
  { body: "ISO", designation: "ISO 8501-1", title: "Preparation of Steel Substrates - Visual Assessment of Surface Cleanliness", current_edition: "2007 Edition", current_year: 2007, domains: ["coatings", "surface_preparation", "blast_cleaning"], materials: ["carbon_steel"], damage_modes: ["corrosion"], thresholds: {} },
  { body: "ISO", designation: "ISO 12944", title: "Paints and Varnishes - Corrosion Protection of Steel by Protective Paint Systems", current_edition: "2018 Edition (Parts 1-9)", current_year: 2018, domains: ["coatings", "corrosion_protection", "paint_systems", "atmospheric", "immersion"], materials: ["carbon_steel", "galvanized_steel"], damage_modes: ["coating_degradation", "corrosion"], thresholds: {} },
  { body: "ISO", designation: "ISO 4628", title: "Paints and Varnishes - Evaluation of Degradation of Coatings", current_edition: "2016 Edition (Parts 1-10)", current_year: 2016, domains: ["coatings", "coating_assessment", "inspection"], materials: ["coated_substrates"], damage_modes: ["blistering", "rusting", "cracking", "flaking", "chalking"], thresholds: {} },

  // ISO — Welding Quality
  { body: "ISO", designation: "ISO 5817", title: "Welding - Fusion-welded Joints in Steel, Nickel, Titanium - Quality Levels for Imperfections", current_edition: "2023 Edition (4th)", current_year: 2023, domains: ["welding", "quality_levels", "fabrication"], materials: ["steel", "nickel", "titanium"], damage_modes: ["weld_defects"], thresholds: {} },
  { body: "ISO", designation: "ISO 17636", title: "Non-destructive Testing of Welds - Radiographic Testing", current_edition: "2013 Edition (Parts 1-2)", current_year: 2013, domains: ["NDE", "radiography", "welding"], materials: ["all"], damage_modes: ["weld_defects"], thresholds: {} },
  { body: "ISO", designation: "ISO 17640", title: "Non-destructive Testing of Welds - Ultrasonic Testing - Techniques, Testing Levels, and Assessment", current_edition: "2018 Edition", current_year: 2018, domains: ["NDE", "ultrasonic", "welding"], materials: ["all"], damage_modes: ["weld_defects"], thresholds: {} },
  ...
  // DNV — Offshore Welding/Fabrication
  { body: "DNV", designation: "DNV-OS-C401", title: "Fabrication and Testing of Offshore Structures", current_edition: "2020 Edition", current_year: 2020, domains: ["offshore", "fabrication", "welding", "testing"], materials: ["structural_steel", "carbon_steel"], damage_modes: ["weld_defects", "fatigue"], thresholds: {} }
];
